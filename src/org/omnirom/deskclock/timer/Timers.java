...
public class Timers {
    ...
    public static final String NOTIF_TOGGLE_STATE = "notif_toggle_state";
    public static final String NOTIF_DELETE_TIMER = "notif_delete_timer";
    public static final String NOTIF_RESET_TIMER = "notif_reset_timer";
    public static final String NOTIF_RESET_ALL_TIMER = "notif_reset_all_timer";
