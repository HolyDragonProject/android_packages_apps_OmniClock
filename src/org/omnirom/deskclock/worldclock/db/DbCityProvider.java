...
package org.omnirom.deskclock.worldclock.db;
...
public class DbCityProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("org.omnirom.deskclock.worldclock.db", "city", CITIES);
        sURLMatcher.addURI("org.omnirom.deskclock.worldclock.db", "city/#", CITIES_ID);
    }
