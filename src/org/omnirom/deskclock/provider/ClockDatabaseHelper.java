...
class ClockDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static void createAlarmsTable(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + ALARMS_TABLE_NAME + " (" +
                ...
                ClockContract.AlarmsColumns.RINGTONE_NAME + " TEXT, " +
                ClockContract.AlarmsColumns.PRE_ALARM_RINGTONE_NAME + " TEXT);");
    ...
    private static void createInstanceTable(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + INSTANCES_TABLE_NAME + " (" +
                ...
                ClockContract.InstancesColumns.RINGTONE_NAME + " TEXT, " +
                ClockContract.InstancesColumns.PRE_ALARM_RINGTONE_NAME + " TEXT);");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int currentVersion) {
        ...
        if (oldVersion <= VERSION_6) {
            ...
            db.execSQL("ALTER TABLE " + INSTANCES_TABLE_NAME
                    ...
                    + " INTEGER NOT NULL DEFAULT 0;");
        } else if (oldVersion < VERSION_9) {
            db.execSQL("ALTER TABLE " + ALARMS_TABLE_NAME
                    + " ADD COLUMN " + ClockContract.AlarmsColumns.RINGTONE_NAME
                    + " TEXT;");
            db.execSQL("ALTER TABLE " + INSTANCES_TABLE_NAME
                    + " ADD COLUMN " + ClockContract.InstancesColumns.RINGTONE_NAME
                    + " TEXT;");
            db.execSQL("ALTER TABLE " + ALARMS_TABLE_NAME
                    + " ADD COLUMN " + ClockContract.AlarmsColumns.PRE_ALARM_RINGTONE_NAME
                    + " TEXT;");
            db.execSQL("ALTER TABLE " + INSTANCES_TABLE_NAME
                    + " ADD COLUMN " + ClockContract.InstancesColumns.PRE_ALARM_RINGTONE_NAME
                    + " TEXT;");
        }
    }
